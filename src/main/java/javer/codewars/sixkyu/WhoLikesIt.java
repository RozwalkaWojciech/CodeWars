...
public class WhoLikesIt {
    ...
    public static String whoLikesIt2(String... nms) {
        return switch (nms.length) {
            ...
            case 1 -> format("%s likes this", nms[0]);
            case 2 -> format("%s and %s like this", nms[0], nms[1]);
            case 3 -> format("%s, %s and %s like this", nms[0], nms[1], nms[2]);
            default -> format("%s, %s and %d others like this", nms[0], nms[1], nms.length - 2);
        };
    }
